  ...
  dark: {
    ...
    colors: {
      nodeAccents: {
        ...
        grid:              { border: '#fb923c', icon: '#fb923c' },
        ups:               { border: '#4ade80', icon: '#4ade80' },
        battery:           { border: '#4ade80', icon: '#4ade80' },
        generator:         { border: '#fbbf24', icon: '#fbbf24' },
        solar_panel:       { border: '#fbbf24', icon: '#fbbf24' },
        inverter:          { border: '#c084fc', icon: '#c084fc' },
        circuit_breaker:   { border: '#ef4444', icon: '#ef4444' },
        contactor:         { border: '#ef4444', icon: '#ef4444' },
        electrical_switch: { border: '#22d3ee', icon: '#22d3ee' },
        socket:            { border: '#94a3b8', icon: '#94a3b8' },
        light:             { border: '#fbbf24', icon: '#fbbf24' },
        meter:             { border: '#22d3ee', icon: '#22d3ee' },
        transformer:       { border: '#c084fc', icon: '#c084fc' },
        load:              { border: '#ec4899', icon: '#ec4899' },
      },
  ...
  light: {
    ...
    colors: {
      nodeAccents: {
        ...
        grid:              { border: '#ea580c', icon: '#ea580c' },
        ups:               { border: '#16a34a', icon: '#16a34a' },
        battery:           { border: '#16a34a', icon: '#16a34a' },
        generator:         { border: '#b45309', icon: '#b45309' },
        solar_panel:       { border: '#b45309', icon: '#b45309' },
        inverter:          { border: '#7c3aed', icon: '#7c3aed' },
        circuit_breaker:   { border: '#dc2626', icon: '#dc2626' },
        contactor:         { border: '#dc2626', icon: '#dc2626' },
        electrical_switch: { border: '#0284c7', icon: '#0284c7' },
        socket:            { border: '#6b7280', icon: '#6b7280' },
        light:             { border: '#b45309', icon: '#b45309' },
        meter:             { border: '#0284c7', icon: '#0284c7' },
        transformer:       { border: '#7c3aed', icon: '#7c3aed' },
        load:              { border: '#db2777', icon: '#db2777' },
      },
  ...
  neon: {
    ...
    colors: {
      nodeAccents: {
        ...
        grid:              { border: '#ff8800', icon: '#ff8800' },
        ups:               { border: '#00ff80', icon: '#00ff80' },
        battery:           { border: '#00ff80', icon: '#00ff80' },
        generator:         { border: '#ffff00', icon: '#ffff00' },
        solar_panel:       { border: '#ffff00', icon: '#ffff00' },
        inverter:          { border: '#ff00ff', icon: '#ff00ff' },
        circuit_breaker:   { border: '#ff0040', icon: '#ff0040' },
        contactor:         { border: '#ff0040', icon: '#ff0040' },
        electrical_switch: { border: '#00ffff', icon: '#00ffff' },
        socket:            { border: '#8888ff', icon: '#8888ff' },
        light:             { border: '#ffff00', icon: '#ffff00' },
        meter:             { border: '#00ffff', icon: '#00ffff' },
        transformer:       { border: '#ff00ff', icon: '#ff00ff' },
        load:              { border: '#ff3399', icon: '#ff3399' },
      },
